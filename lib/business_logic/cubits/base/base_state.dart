...
enum CubitErrorCode {
  /// Failed to get the device location, make sure the device location service
  /// is enabled.
  locationServiceDisabled('location_service_disabled'),

  /// Failed to get the device location, make sure the app has permission to
  /// request the device location.
  locationPermissionDenied('location_permission_denied'),

  /// A generic error for when the lcoation service is misbehaving
  locationServiceError('location_service_error'),
